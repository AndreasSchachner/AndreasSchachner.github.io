...
- **stringjax** ([GitHub](https://github.com/AndreasSchachner/stringjax) &middot;
...
- **jaxvacua** ([GitHub](https://github.com/AndreasSchachner/jaxvacua) &middot;
...
- **stringforge** ([GitHub](https://github.com/AndreasSchachner/stringforge) &middot;
...
- **jaxpolylog** ([GitHub](https://github.com/AndreasSchachner/jaxpolylog) &middot;
...
All four packages are `pip install`-able, GPL-3.0, Python&nbsp;&ge;&nbsp;3.12,
