/*! Catalog v3.6.2 https://www.catalog.style/ */
...
import { Link, Route, Router, browserHistory, hashHistory, applyRouterMiddleware } from 'react-router';
import { useScroll } from 'react-router-scroll';
import { parse as parse$1 } from 'url';
import createEmotion from 'create-emotion';
import { filter, complement, isEmpty, compose, split, mergeAll, is, toLower, head, or } from 'ramda';
import { Type, Schema, CORE_SCHEMA, safeLoad } from 'js-yaml';
...
var ColorPalette = function (_React$Component) {
  ...
  ColorPalette.prototype.render = function render() {
    ...
    var width = (horizontal ? 100 / colors.length : 100) + "%";
  ...
  Video.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: parsedSrc, target: "_blank", rel: "norel noreferrer" },
          "video"
        ),
        " ",
        "in a new Tab"
